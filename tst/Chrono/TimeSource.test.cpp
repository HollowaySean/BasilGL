...
TEST_CASE("Chrono_TimeSource_getTimestamp") {
...
TEST_CASE("Chrono_TimeSource_waitForDuration") {
...
TEST_CASE("Chrono_TimeSource_waitUntilTime") {
    SECTION("Sleeps for time provided") {
        auto sleepTime = std::chrono::milliseconds(100);
...
TEST_CASE("Chrono_TimeSource_frequencyToPeriod") {
...
TEST_CASE("Chrono_TimeSource_periodToFrequency") {
    SECTION("Returns zero for zero input") {
